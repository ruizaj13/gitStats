const particleStyles = {
    ...
    particles: {
      ...
      color: {
        ...
        value: '#4183C4' //Or use an array of colors like ["#9b0000", "#001378", "#0b521f"]
      },
      shape: {
      ...
      move: {
        enable: true,
        speed: 2,
        direction: "top-right", //Move them off the canvas, either "none", "top", "right", "bottom", "left", "top-right", "bottom-right" et cetera...
        random: true,
